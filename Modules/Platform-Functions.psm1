...
Function Authenticate-Platform {
    ...
    Try {
        ...
        $logonheader = $null
        switch ($authType) {
            "cyberark" { $logonheader = Get-PVWALogonHeader -Url $platformURLs.pvwaURL -Credentials $creds -ErrorVariable respERR}
            "identity" { $logonheader = Get-IdentityHeader -IdentityTenantURL $platformURLs.IdentityURL -UPCreds $creds -ErrorVariable respERR }
        }

        return $logonheader
    } Catch {
        Write-LogMessage -Type Error -Msg "Error: $(Collect-ExceptionMessage $_.exception.message $($_.ErrorDetails.Message) $($_.exception.status) $($_.exception.Response.ResponseUri.AbsoluteUri) $respERR)"
    }
}
# SIG # Begin signature block
# MIIqRQYJKoZIhvcNAQcCoIIqNjCCKjICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD6cnOk0c3xghqf
# gGrPphgGr3RBaUF7voHO6wArNRYbY6CCGFcwggROMIIDNqADAgECAg0B7l8Wnf+X
...
# AQkEMSIEIE7kU/VlnXBoZhVQwadbJ3TNtZhEQxhFrSrOizMjaHZOMA0GCSqGSIb3
# DQEBAQUABIICAEEbfWA+sQ3pjk1zR7A36EjT27cDcAB0xzsRpcFECCrIoPJ40Qmt
# tjpSKrSpdKapSuEJa0Aa3rU3+F29OycHhRYUNp0IHK0aCbWoFSlJsekUhzdAADWG
# OrZRYtbHyz8M2J9tdasHyVM/MIBAbhkDskLejacnJCYx3dFXsvOqM2CXHnx+3TwA
# 9G4oOHJlUyp5OIwAijmd0N+0SPpbsuNYyQqAbrRRRRTZ5yl9Y/MqiUGAI1T1/rMO
# Gi2lUGS+Y49RSP10AEuwryptRjeZoJIN8esgjDgZ4iJI0GHLZ2PHSC+YKFIzW/g0
# qI6YoVBNwxa0FZWQ6Wdql+hyO2J+6gj9OI33ie5yDXbWdjhPC9Ipax5xMo+cVKGf
# gXAY4cs3yRjb5j9F2dtzgx8r/KMHYrATBih+J8eaTokhoIrSvNPkayEQhxmYImVM
# paqJFzAqh/KwxCc+clYpH/icOAtQMlQpQX1DITWjf98H2nT/MjfjmC++OLXWh0WX
# fg9gdlkd4ovaDKHWSlaPDtyJ4KlRG3FXVV6GieQvX+dWy4hGQRI3d+ga16sgLxe8
# z+ZeDd0xrfTC4NvVGsV/42wuMeQg28tZnNkx2N4aiouLuEyVwJuOWg9LU3AL2zvK
# EO++yAyBBUPC/b10tAvDovobfn7G152WdiJkPGGGNpJ5w8wJshS7fRmqoYIOKzCC
...
# AQcXAzAhMAkGBSsOAwIaBQAEFMDDXfmV5jh/Clcp8uGi0YrAaU75AhRwIxBw8bpW
# NI1tamTY+w5AJYEb6BgPMjAyNDAzMDcyMzAyNTVaMAMCAR6ggYakgYMwgYAxCzAJ
...
# MBwGCSqGSIb3DQEJBTEPFw0yNDAzMDcyMzAyNTVaMC8GCSqGSIb3DQEJBDEiBCBq
# sovZupFfMA8Dh0spONgLFtDoBaiSk1GlwVlJOBSxqDA3BgsqhkiG9w0BCRACLzEo
# MCYwJDAiBCDEdM52AH0COU4NpeTefBTGgPniggE8/vZT7123H99h+DALBgkqhkiG
# 9w0BAQEEggEAisWMnDejT8uBNI3Q4KJDTMpjzEFFo4mZDfSNkk/No+u1HQ4RHV5/
# HbtaJmV/oi1I1JLG3VVkoMXn4UOFftJTBqMh1t97P0Kz9Aic5//MQWZPe+5VAJxJ
# 8L1muXSunEcK0cG1bOSRupRdzsGAR+DhD02m2Z/OrORLglwIeAoDkw2ebTyNHiCY
# 8rofcDLKFhv4CBtDPiwcK3X97nwtFefc4qGhs4tTbYpVQ8AETkqYaSxiwYcrRcbu
# BQizLecDzx0x9w4mPacOSdyhdLCaeRxwpKwh1d+Q9TABR7/2zbTDl+sRwYwTsmGP
# faY9R1TiGi2bHfKxDDyeMPIYGyb0IekE+Q==
